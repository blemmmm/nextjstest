  ...
  return (
    <div>
      ...
      <div class="relative bg-indigo-100">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 px-28 py-48">
          <input type="email" placeholder="yourmail@example.com" class="flex-1 appearance-none rounded-lg shadow-md py-2 px-4 w-3/6 font-semibold text-grey-dark mr-2 focus:outline-none" />
          <button type="submit" class="py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-indigo-500 hover:bg-yellow-600">SUBSCRIBE</button>
        </div>
      </div>
